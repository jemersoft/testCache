...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'national Georgia synthesizing', price: 5818, productSize: 'XL' };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      ...
      cy.get(`[data-cy="image"]`).type('invoice International Granite').should('have.value', 'invoice International Granite');
